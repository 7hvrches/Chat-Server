 ...
 * 채팅방 정보를 조회 시 Redis Hash에 저장된 데이터를 불러오도록 설정
 * 채팅방 입장 시에는 채팅방 id로 Redis 채팅방을 조회하여 pub/sub 메시지 리스너와 연동
 */
...
public class ChatRoomRepository {
    ...
    public List<ChatRoom> findAllRoom() {
        return new ArrayList<>(opsHashChatRoom.values(CHAT_ROOMS));    }
